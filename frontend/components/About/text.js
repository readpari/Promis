export const text = {
  ...
  RU: [
    ...
    // 'Вы можете обмануть Promise, часами бездумно листая страницы, уставившись в стенку. Promise по-настоящему умный смарт-контракт, но увы, он не в силах одолеть человеческий интеллект, поэтому деньги он Вам вернет, но потраченные нервы и время, увы нет.',
    //'Удачного чтения.',
  ],
  CHN: [
  ...
  FR: [
    'Promise est un lecteur simple doté de pouvoirs magiques. Il faut beaucoup de volonté pour lire beaucoup. Promise vous donnera ce pouvoir.',
    ...
    "Comment fonctionne Promise. \n Promise travaille sur la blockchain à proximité. Il s'agit d'un simple contrat intelligent open source. Un contrat intelligent est un portefeuille intelligent qui gère son argent selon un algorithme strictement défini. Il ne peut pas être modifié, bloqué ou piraté.",
    ...
    "Vous pouvez tromper Promise en tournant sans réfléchir les pages sans lire le contenu. Promise est un contrat intelligent vraiment intelligent, mais hélas, il n'est pas capable de vaincre l'intellect humain. Pour vous protéger de sa propre ruse, Promise vous invite à lire les livres de sa bibliothèque. Ces livres contiennent des questions simples. Si vous répondez ne serait-ce qu'une seule fois, vous perdez.",
    'Nous vous souhaitons une bonne lecture.',
  ],
  GRM: [
    'Promise ist ein einfaches Lesebuch mit magischen Kräften. Es braucht viel Willenskraft, um viel zu lesen. Promise wird dir diese Kraft geben.',
    ...
    'So funktioniert Promise. \n Promise arbeitet an der Blockchain in der Nähe. Es ist ein einfacher Open Source Smart Contract. Ein Smart Contract ist eine Smart Wallet, die ihr Geld nach einem fest definierten Algorithmus verwaltet. Es kann nicht geändert, blockiert oder gehackt werden.',
    ...
    'Sie können Promise täuschen, indem Sie gedankenlos Seiten umblättern, ohne den Inhalt zu lesen. Promise ist ein wirklich intelligenter Smart Contract, aber leider ist er nicht in der Lage, den menschlichen Intellekt zu besiegen. Um Sie vor seiner eigenen List zu schützen, lädt Promise Sie ein, Bücher aus seiner Bibliothek zu lesen. Diese Bücher enthalten einfache Fragen. Wenn Sie auch nur eine falsch beantworten, verlieren Sie.',
    'Wir wünschen Ihnen viel Spaß beim Lesen.',
  ],
  ITL: [
    'Promise è un semplice lettore con poteri magici. Ci vuole molta forza di volontà per leggere molto. Promise ti darà quel potere.',
    ...
    'Come funziona Book Jack. \n Promise lavora sulla blockchain vicino. È un semplice contratto intelligente open source. Uno smart contract è un portafoglio intelligente che gestisce i suoi soldi secondo un algoritmo rigorosamente definito. Non può essere modificato, bloccato o violato.',
    ...
    "Puoi ingannare Promise sfogliando le pagine senza pensare senza leggere il contenuto. Promise è un contratto intelligente davvero intelligente, ma purtroppo non è in grado di sconfiggere l'intelletto umano. Per proteggerti dal suo stesso stratagemma, Promise ti invita a leggere i libri della sua biblioteca. Questi libri contengono domande semplici. Se rispondi anche a una sola risposta sbagliata, perdi.",
    'Vi auguriamo buona lettura.',
  ],
  SPN: [
    'Promise es un simple lector con poderes mágicos. Se necesita mucha fuerza de voluntad para leer mucho. Promise te dará ese poder.',
    ...
    'Cómo funciona Promise. \n Promise trabaja en la cadena de bloques cercana. Es un simple contrato inteligente de código abierto. Un contrato inteligente es una billetera inteligente que administra su dinero de acuerdo con un algoritmo estrictamente definido. No se puede cambiar, bloquear o hackear.',
    ...
    'Puedes engañar a Promise pasando páginas sin pensar sin leer el contenido. Promise es un contrato inteligente verdaderamente inteligente, pero, por desgracia, no puede vencer al intelecto humano. Para protegerte de su propia artimaña, Promise te invita a leer libros de su biblioteca. Estos libros contienen preguntas simples. Si respondes aunque sea una sola incorrectamente, pierdes.',
