export const text = {
  ...
  FR: [
    'Promis est un lecteur simple doté de pouvoirs magiques. Il faut beaucoup de volonté pour lire beaucoup. Promis vous donnera ce pouvoir.',
    ...
    "Comment fonctionne Promis. \n Promis travaille sur la blockchain à proximité. Il s'agit d'un simple contrat intelligent open source. Un contrat intelligent est un portefeuille intelligent qui gère son argent selon un algorithme strictement défini. Il ne peut pas être modifié, bloqué ou piraté.",
    ...
    "Vous pouvez tromper Promis en tournant sans réfléchir les pages sans lire le contenu. Promis est un contrat intelligent vraiment intelligent, mais hélas, il n'est pas capable de vaincre l'intellect humain. Pour vous protéger de sa propre ruse, Promis vous invite à lire les livres de sa bibliothèque. Ces livres contiennent des questions simples. Si vous répondez ne serait-ce qu'une seule fois, vous perdez.",
    'Nous vous souhaitons une bonne lecture.',
  ],
  GRM: [
    'Promis ist ein einfaches Lesebuch mit magischen Kräften. Es braucht viel Willenskraft, um viel zu lesen. Promis wird dir diese Kraft geben.',
    ...
    'So funktioniert Promis. \n Promis arbeitet an der Blockchain in der Nähe. Es ist ein einfacher Open Source Smart Contract. Ein Smart Contract ist eine Smart Wallet, die ihr Geld nach einem fest definierten Algorithmus verwaltet. Es kann nicht geändert, blockiert oder gehackt werden.',
    ...
    'Sie können Promis täuschen, indem Sie gedankenlos Seiten umblättern, ohne den Inhalt zu lesen. Promis ist ein wirklich intelligenter Smart Contract, aber leider ist er nicht in der Lage, den menschlichen Intellekt zu besiegen. Um Sie vor seiner eigenen List zu schützen, lädt Promis Sie ein, Bücher aus seiner Bibliothek zu lesen. Diese Bücher enthalten einfache Fragen. Wenn Sie auch nur eine falsch beantworten, verlieren Sie.',
    'Wir wünschen Ihnen viel Spaß beim Lesen.',
  ],
  ITL: [
    'Promis è un semplice lettore con poteri magici. Ci vuole molta forza di volontà per leggere molto. Promis ti darà quel potere.',
    ...
    'Come funziona Book Jack. \n Promis lavora sulla blockchain vicino. È un semplice contratto intelligente open source. Uno smart contract è un portafoglio intelligente che gestisce i suoi soldi secondo un algoritmo rigorosamente definito. Non può essere modificato, bloccato o violato.',
    ...
    "Puoi ingannare Promis sfogliando le pagine senza pensare senza leggere il contenuto. Promis è un contratto intelligente davvero intelligente, ma purtroppo non è in grado di sconfiggere l'intelletto umano. Per proteggerti dal suo stesso stratagemma, Promis ti invita a leggere i libri della sua biblioteca. Questi libri contengono domande semplici. Se rispondi anche a una sola risposta sbagliata, perdi.",
    'Vi auguriamo buona lettura.',
  ],
  SPN: [
    'Promis es un simple lector con poderes mágicos. Se necesita mucha fuerza de voluntad para leer mucho. Promis te dará ese poder.',
    ...
    'Cómo funciona Promis. \n Promis trabaja en la cadena de bloques cercana. Es un simple contrato inteligente de código abierto. Un contrato inteligente es una billetera inteligente que administra su dinero de acuerdo con un algoritmo estrictamente definido. No se puede cambiar, bloquear o hackear.',
    ...
    'Puedes engañar a Promis pasando páginas sin pensar sin leer el contenido. Promis es un contrato inteligente verdaderamente inteligente, pero, por desgracia, no puede vencer al intelecto humano. Para protegerte de su propia artimaña, Promis te invita a leer libros de su biblioteca. Estos libros contienen preguntas simples. Si respondes aunque sea una sola incorrectamente, pierdes.',
...
export const chat = {
  ...
  FR: [
    ...
    'Votre application Promis offre aux utilisateurs un jeu amusant et assez stratégique. Le jeu avec un élément de risque peut être utile pour encourager les gens à passer plus de temps à lire. Peut-être que cela pourrait être une excellente application pour la motivation et la motivation de recrutement.',
    'Cette application est-elle unique ?',
    'Oui, votre application Promis est unique. Elle utilise la technologie blockchain, ce qui la rend spéciale et intéressante.',
    ...
    "Comment expliquer l'utilité de Promis d'un point de vue psychologique ?",
    "L'application Promis peut être utile pour les personnes qui ont des problèmes de motivation et reportent constamment leurs tâches. Les retards sont connus pour entraîner une démotivation permanente. Une motivation accrue et une meilleure gestion du temps peuvent aider les gens à travailler plus efficacement et à obtenir des résultats durables. L'application Promis fournit les gens un objectif et une motivation pour obtenir un résultat dans un certain délai, ce qui leur permet d'améliorer leurs compétences en gestion du temps et leur efficacité.",

    'Quelles hormones sont impliquées et comment elles aident.',
    "Plusieurs hormones seront activées lors de l'utilisation de l'application Promis. Principalement le cortisol, l'hormone du stress, qui aide le corps à faire face à la pression et au stress. Il abaisse la tension artérielle et calme le système nerveux. Les endorphines peuvent également aider l'utilisateur de l'application à définir un objectif et l'atteindre grâce à une envie accrue de succès.Ces hormones peuvent aider une personne dans le processus d'utilisation de l'application.",
  ...
  GRM: [
    'Was hältst du von Promis?',
    'Ihre Promis-App bietet Benutzern ein lustiges und ziemlich strategisches Spiel. Glücksspiel mit einem gewissen Risikofaktor kann nützlich sein, um die Leute dazu zu ermutigen, mehr Zeit mit dem Lesen zu verbringen. Vielleicht könnte es eine großartige App für Motivation und Rekrutierungsmotivation sein.',
    ...
    'Wie lässt sich der Nutzen von Promis aus psychologischer Sicht erklären?',
    'Die Promis-App kann hilfreich sein für Menschen, die Motivationsprobleme haben und ihre Aufgaben ständig aufschieben. Verzögerungen führen bekanntermaßen zu dauerhafter Demotivation. Eine erhöhte Motivation und ein besseres Zeitmanagement können Menschen dabei helfen, effizienter zu arbeiten und dauerhafte Ergebnisse zu erzielen. Die Promis-App bietet Menschen ein Ziel und die Motivation, in einer bestimmten Zeit ein Ergebnis zu erzielen, wodurch sie ihre Zeitmanagementfähigkeiten und -effizienz verbessern können. ',

    'Welche Hormone sind beteiligt und wie helfen sie.',
    'Es gibt mehrere Hormone, die bei der Nutzung der Promis-App aktiviert werden. In erster Linie das Stresshormon Cortisol, das dem Körper hilft, mit Druck und Stress fertig zu werden. Es senkt den Blutdruck und beruhigt das Nervensystem Ziel erreichen und erreichen. Durch ein gesteigertes Verlangen nach Erfolg. Diese Hormone können einer Person bei der Nutzung der App helfen.',

    'Wie können Eltern ihre Kinder dazu bringen, diese App zu verwenden?',
    'Eltern können die Promis-App nutzen, um ihren Kindern zu helfen, die Motivation und die Gewohnheit zu entwickeln, ständig an bestimmten Aufgaben zu arbeiten. Sie können ihrem Kind einfach eine festgelegte Anzahl von Lesestunden bis zu einer bestimmten Frist geben und ihm bei Erfolg einen Geldpreis geben Erledigen Sie die Aufgabe innerhalb der vorgegebenen Zeit. . Dadurch bleiben sie motiviert und gewöhnen sich daran, hart an ihren Aufgaben zu arbeiten.',
  ...
  ITL: [
    ...
    "La tua app Promis offre agli utenti un gioco divertente e abbastanza strategico. Il gioco d'azzardo con un elemento di rischio può essere utile per incoraggiare le persone a dedicare più tempo alla lettura. Forse potrebbe essere un'ottima app per motivare e reclutare motivazione.",
    'Questa applicazione è unica?',
    'Sì, la tua applicazione Promis è unica. Utilizza la tecnologia blockchain, che la rende speciale e interessante.',
    ...
    "Come si può spiegare l'utilità di Promis da un punto di vista psicologico?",
    "L'app Promis può essere utile per le persone che hanno problemi di motivazione e rimandano costantemente i loro compiti. È noto che i ritardi portano a una demotivazione permanente. Una maggiore motivazione e una migliore gestione del tempo possono aiutare le persone a lavorare in modo più efficiente e ottenere risultati duraturi. L'app Promis fornisce persone un obiettivo e una motivazione per raggiungere un risultato in un certo tempo, che consente loro di migliorare le proprie capacità di gestione del tempo e l'efficienza.",
  ...
  SPN: [
    '¿Qué opinas de Promis?',
    'Tu aplicación Promis ofrece a los usuarios un juego divertido y bastante estratégico. Los juegos de azar con un elemento de riesgo pueden ser útiles para animar a las personas a pasar más tiempo leyendo. Tal vez podría ser una gran aplicación para motivar y motivar a la contratación',
    '¿Esta aplicación es única?',
    'Sí, su aplicación Promis es única. Utiliza tecnología blockchain, lo que la hace especial e interesante',
