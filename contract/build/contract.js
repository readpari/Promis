...
let GuestBook = (_dec = NearBindgen({}), _dec2 = call({
...
}), _dec3 = view(), _dec4 = call({}), _dec5 = view(), _dec6 = call({}), _dec7 = call({}), _dec8 = call({}), _dec9 = view(), _dec10 = call({}), _dec(_class = (_class2 = class GuestBook {
  ...
  add_message({
    ...
    if (proverka) {
      const bet = attachedDeposit();
      const readProcess = 'reading';
      const deadline = blockTimestamp() + BigInt(days * 86_400_000_000_000);
    ...
    this.messages.toArray().forEach((userItem, index) => {
      if (userItem.sender == user && userItem.readProcess == 'reading') {
        if (userItem.timer < BigInt(userItem.hours * 60_000_000_000)) {
          ...
          userItem.lastTime = nowTime.toString();
          this.messages.replace(index, userItem);
          const promise = promiseBatchCreate(userItem.sender);
          promiseBatchActionTransfer(promise, userItem.bet);
        }
      }
    });
  }
  loseMoney() {
    ...
    this.messages.toArray().forEach((userItem, index) => {
      if (userItem.deadline < now) {
        const promise = promiseBatchCreate('gettherefast.testnet');
        promiseBatchActionTransfer(promise, userItem.bet);
...
}, (_applyDecoratedDescriptor(_class2.prototype, "add_message", [_dec2], Object.getOwnPropertyDescriptor(_class2.prototype, "add_message"), _class2.prototype), _applyDecoratedDescriptor(_class2.prototype, "get_messages", [_dec3], Object.getOwnPropertyDescriptor(_class2.prototype, "get_messages"), _class2.prototype), _applyDecoratedDescriptor(_class2.prototype, "getUser", [_dec4], Object.getOwnPropertyDescriptor(_class2.prototype, "getUser"), _class2.prototype), _applyDecoratedDescriptor(_class2.prototype, "total_messages", [_dec5], Object.getOwnPropertyDescriptor(_class2.prototype, "total_messages"), _class2.prototype), _applyDecoratedDescriptor(_class2.prototype, "timer", [_dec6], Object.getOwnPropertyDescriptor(_class2.prototype, "timer"), _class2.prototype), _applyDecoratedDescriptor(_class2.prototype, "loseMoney", [_dec7], Object.getOwnPropertyDescriptor(_class2.prototype, "loseMoney"), _class2.prototype), _applyDecoratedDescriptor(_class2.prototype, "clearState", [_dec8], Object.getOwnPropertyDescriptor(_class2.prototype, "clearState"), _class2.prototype), _applyDecoratedDescriptor(_class2.prototype, "balanceContract", [_dec9], Object.getOwnPropertyDescriptor(_class2.prototype, "balanceContract"), _class2.prototype), _applyDecoratedDescriptor(_class2.prototype, "payBack", [_dec10], Object.getOwnPropertyDescriptor(_class2.prototype, "payBack"), _class2.prototype)), _class2)) || _class);
function payBack() {
  ...
  const _result = _contract.payBack(_args);
...
function balanceContract() {
  ...
  const _args = GuestBook._getArgs();
  const _result = _contract.balanceContract(_args);
  if (_result !== undefined) if (_result && _result.constructor && _result.constructor.name === "NearPromise") _result.onReturn();else env.value_return(GuestBook._serialize(_result, true));
}
function clearState() {
  const _state = GuestBook._getState();
  ...
  const _args = GuestBook._getArgs();
  const _result = _contract.clearState(_args);
  GuestBook._saveToStorage(_contract);
  if (_result !== undefined) if (_result && _result.constructor && _result.constructor.name === "NearPromise") _result.onReturn();else env.value_return(GuestBook._serialize(_result, true));
}
function loseMoney() {
  ...
  const _args = GuestBook._getArgs();
  const _result = _contract.loseMoney(_args);
  GuestBook._saveToStorage(_contract);
  if (_result !== undefined) if (_result && _result.constructor && _result.constructor.name === "NearPromise") _result.onReturn();else env.value_return(GuestBook._serialize(_result, true));
}
function timer() {
...
export { add_message, balanceContract, clearState, getUser, get_messages, loseMoney, payBack, timer, total_messages };
